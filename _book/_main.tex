...
\caption{\label{tab:func-table1}A table of the 8 custom cleaning and wrangling functions created to wrangle the ACS data.}
\centering
\begin{tabular}[t]{l|l}
\hline
Script & Purpose\\
...
\caption{\label{tab:func-table2}A table of the 2 custom cleaning and wrangling functions created to wrangle the RIDB.}
\centering
\begin{tabular}[t]{l|l}
\hline
Script & Purpose\\
...
\caption{\label{tab:func-table3}A table of the single custom function created to combine RIDB and ACS data.}
\centering
\begin{tabular}[t]{l|l}
\hline
Script & Purpose\\
...
\caption{\label{tab:func-table4}A table of the 6 custom cleaning and wrangling functions to create data sets for visitorshed maps and data relationship plots.}
\centering
\begin{tabular}[t]{l|l}
\hline
Script & Purpose\\
...
This technical documentation is created with the \texttt{bookdown} package \citep{R-bookdown} and is linked in the user guide section of the Outdoor Equity App. Metadata for all variables used within the app are also available on the app Metadata tab and in \protect\hyperlink{products-and-deliverables}{Products and Deliverables Section}.
