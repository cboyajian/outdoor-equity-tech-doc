...
A full glossary can be found in the \protect\hyperlink{appedix}{Appendix Section}.
...
See the \protect\hyperlink{appedix}{Appendix Section} for a full table of all functions.
...
A condensed list of all metadata can be found in the \protect\hyperlink{appedix}{Appendix Section}. A full list of all metadata can be found in the \href{https://shinyapps.bren.ucsb.edu/oe_app/}{Outdoor Equity App} on the Metadata tab.

\hypertarget{packages-and-versions-used}{%
\section{Packages and Versions Used}\label{packages-and-versions-used}}

See the \protect\hyperlink{appedix}{Appendix Section} for the full list of packages used.
...
\href{https://ridb.recreation.gov/standards}{Data standards for the RIDB data} is in the processing of being updated as of June 2022. Users should check to see if this impacts any decisions in adding additional years to the Outdoor Equity App.
...
\caption{\label{tab:unnamed-chunk-34}Metadata of joined RIDB-ACS dataset}
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\hline
Variable Name & Definition & Unit & Data Type\\
\hline
agency & the governing body that manages a type of US public land (i.e. national park, national forest) & NA & categorical\\
\hline
admin\_unit & the parent location or region description that a campsite belongs within & NA & categorical\\
\hline
park & the name of a campsite & NA & categorical\\
\hline
aggregated\_site\_type & type of site at a campsite; a campsite can have multiple site types & NA & categorical\\
\hline
facility\_id & unique id given to a campsite & NA & discrete\\
\hline
facility\_state & the state that a campsite is located in & NA & categorical\\
\hline
customer\_zip & the numeric code of the area from where a visitor lives & NA & categorical\\
\hline
customer\_zip\_state & state acronym for home state of visitor & NA & categorical\\
\hline
customer\_zip\_state\_full & full name of state for home state of visitor & NA & categorical\\
\hline
total\_paid & total amount of dollars paid for a reservation & dollars & continuous\\
\hline
start\_date & date when booked reservation begins & yyyy-mm-dd & discrete\\
\hline
end\_date & date when booked reservation ends & yyyy-mm-dd & discrete\\
\hline
order\_date & date when reservation was booked and purchased & yyyy-mm-dd & discrete\\
\hline
number\_of\_people & number of people reported when booking reservation & person & discrete\\
\hline
length\_of\_stay & the number of days a visit is; difference of end date from start date & days & discrete\\
\hline
booking\_window & the number of days a reservation is made before the start of the visit; difference of start date from order date & days & discrete\\
\hline
daily\_cost & the total amount paid per day for a reservation & dollars & continuous\\
\hline
daily\_cost\_per\_visitor & the total amount paid per day for one person & dollars & continuous\\
\hline
facility\_latitude & latitude of the campsite, but note this may not be the center of the campsite & degrees & continuous\\
\hline
facility\_longitude & longitude of the campsite, but note this may not be the center of the campsite & degrees & continuous\\
\hline
distance\_traveled\_m & distance between visitor home zip code and campsite & meters & continuous\\
\hline
zip\_code\_population.x & the zip code population when get\_acs()  from tidycensus pulls in data for education variable. Note we take the average of zip code population x, zip code population y, and zip code population  in our data wrangling script & person & discrete\\
\hline
asian & estimated percentage of asian population in a zip code & percentage & continuous\\
\hline
black & estimated percentage of black population in a zip code & percentage & continuous\\
\hline
hispanic\_latinx & estimated percentage of hispanic latinx population in a zip code & percentage & continuous\\
\hline
multiracial & estimated percentage of multiracial population in a zip code & percentage & continuous\\
\hline
native\_american & estimated percentage of native american population in a zip code & percentage & continuous\\
\hline
other & estimated percentage of other population in a zip code & percentage & continuous\\
\hline
pacific\_islander & estimated percentage of pacific islander population in a zip code & percentage & continuous\\
\hline
white & estimated percentage of white population in a zip code & percentage & continuous\\
\hline
zip\_code\_population.y & the zip code population when get\_acs()  from tidycensus pulls in data for language variable. Note we take the average of zip code population x, zip code population y, and zip code population  in our data wrangling script & person & discrete\\
\hline
college & estimated percentage of population with a college degree in a zip code & percentage & continuous\\
\hline
hs\_GED\_or\_below & estimated percentage of population with a high school General Educational Development (GED) degree or below in a zip code & percentage & continuous\\
\hline
master\_or\_above & estimated percentage of population with a master degree or above in a zip code & percentage & continuous\\
\hline
some\_college & estimated percentage of population with some college education in a zip code & percentage & continuous\\
\hline
median\_income & median household income in the past 12 months in 2019 inflation-adjusted dollars & dollars & continuous\\
\hline
zip\_code\_population & total number of people living in a zip code when get\_acs() from tidycensus pulls in race variable.  Note we take the average of zip code population x, zip code population y, and zip code population  in our data wrangling script & person & discrete\\
\hline
english\_only & estimated percentage of population that speak only english in the home in a zip code & percentage & continuous\\
\hline
not\_english\_only & estimated percentage of population that speak a language other than english in the home in a zip code & percentage & continuous\\
\hline
\end{tabu}
\end{table}
...
\caption{\label{tab:unnamed-chunk-35}Table includes information on packages used to create the Outdoor Equity App.}
