...
Our code is version controlled in a [GitHub repository](https://github.com/outdoor-equity/outdoor-equity). This includes the data cleaning, wrangling, and analysis, creation of plots and maps, and structure of the shiny app. An overview of the directory structure can be found [here]().
  ...
  geom_point(
    aes(
      ...
      text = paste0(
        ...
        "<br>", education, 
        " as the maximum level of education. Typically these visitors reserved their visit between",
